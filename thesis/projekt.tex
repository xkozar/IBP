...
% I have listed all the literary sources, publications and other sources, which were used during the preparation of this thesis.},
  ...
  acknowledgment={Chcel by som poďakovať môjmu vedúcemu tejto práce pánovi prof. RNDr. Alexandrovi Medunovi, CSc. za odborné vedenie tejto práce a jeho cenné rady.
  
  Ďalej by som chcel poďakovať Adriáne Kožárovej, ktorá ma vychovala a vždy podporovala.
  
  V nesposlednom rade by som rád poďakoval kamarátom a kamarátkam, ktorý ma sprevádzali životom počas písania tejto práce. Či už to bolo pri pive alebo pri tepelnej úprave langošov.},
